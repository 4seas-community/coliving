...
[[ "${origin_url}" == "https://github.com/4seas-community/coliving.git" || \
   "${origin_url}" == "git@github.com:4seas-community/coliving.git" ]] || fail \
  "origin must be the canonical GitHub coliving repository"
